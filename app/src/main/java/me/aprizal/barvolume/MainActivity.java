        ...
        btnCalculate.setOnClickListener(v -> {
            if (v.getId()==R.id.btn_calculate){
                ...
                if (TextUtils.isEmpty(inputLength)){
                    isEmptyFields=true;
                    edtLength.setError(getString(R.string.field_not_empty));
                }

                if (TextUtils.isEmpty(inputWidth)){
                    isEmptyFields=true;
                    edtWidth.setError(getString(R.string.field_not_empty));
                }

                if (TextUtils.isEmpty(inputHeight)){
                    isEmptyFields=true;
                    edtHeight.setError(getString(R.string.field_not_empty));
                }
